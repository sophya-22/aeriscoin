...
*Setup instructions for a Gitian build of Aeris Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Aeris
...
- [Building Aeris Core](#building-aeriscoin-core)
...
To build Aeris Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/aeriscoin-project/aeriscoin
