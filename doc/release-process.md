...
* Update manpages, see [gen-manpages.sh](https://github.com/aeriscoin/aeriscoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Aeriscoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Aeriscoin Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [aeriscoin-detached-sigs](https://github.com/aeriscoin/aeriscoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the aeriscoin.org server.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Aeriscoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/aeriscoin/aeriscoin/releases/new) with a link to the archived release notes.
