...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Aeris Core aeris-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aeris-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aeris transaction") + "\n" +
                               "  aeris-tx [options] -create [commands]   " + _("Create hex-encoded aeris transaction") + "\n" +
                               "\n";
