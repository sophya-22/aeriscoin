/* src/config/aeriscoin-config.h.  Generated from aeriscoin-config.h.in by configure.  */
/* src/config/aeriscoin-config.h.in.  Generated from configure.ac by autoheader.  */
