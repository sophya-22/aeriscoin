...
{
    if(fLiteMode) return; // ignore all Aeriscoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Aeriscoin and make it unusable. To
...
bool CDarksendPool::MakeCollateralAmounts(const CompactTallyItem& tallyItem)
{
    ...
    vecSend.push_back((CRecipient) {
        scriptCollateral, PRIVATESEND_COLLATERAL*4, false
    });
