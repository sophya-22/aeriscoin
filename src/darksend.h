...
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 70701;

static const CAmount PRIVATESEND_COLLATERAL         = 0.001 * COIN;
static const CAmount PRIVATESEND_POOL_MAX           = 999999.999 * COIN;
...
{
public:
    /// Is the input associated with this public key? (and there is 1000 ARS - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of aeriscoin.
