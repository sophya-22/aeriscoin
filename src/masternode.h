...
static const int MASTERNODE_MIN_MNB_SECONDS             =   80;
static const int MASTERNODE_MIN_MNP_SECONDS             =  160;
static const int MASTERNODE_EXPIRATION_SECONDS          =  1040;
static const int MASTERNODE_WATCHDOG_MAX_SECONDS        = 1920;
static const int MASTERNODE_NEW_START_REQUIRED_SECONDS  = 2880;
