    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Aeriscoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aeriscoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aeriscoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Aeriscoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aeriscoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aeriscoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aeriscoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aeriscoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a aeriscoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aeriscoin Core help message to get a list with possible Aeriscoin Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        toolbar->addAction(aeriscoinbankAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Aeriscoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aeriscoin network", "", count));
}
...
{
    QString strTitle = tr("Aeriscoin Core"); // default title
    ...
    // Append title to "Aeriscoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
