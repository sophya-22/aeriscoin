    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Aeris Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aeris address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aeris: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Aeris Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aeris Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aeris Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aeris addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aeris addresses"));
    ...
    openAction->setStatusTip(tr("Open a aeris: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aeris Core help message to get a list with possible Aeris Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        toolbar->addAction(aerisbankAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Aeris Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aeris network", "", count));
}
...
{
    QString strTitle = tr("Aeris Core"); // default title
