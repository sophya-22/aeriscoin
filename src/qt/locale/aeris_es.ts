...
<context>
    ...
    <message>
        <source>To use aerisd, or the -server option to aeris-qt, you must set an rpcpassword in the configuration file:
%s
...
for example: alertnotify=echo %%s | mail -s "Aeris Alert" admin@foo.com
        ...
        <translation>Para usar aerisd, o la opción -server de aeris-qt, debe establecer rpcpassword en el archivo de configuración:
%s
