    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ARS-light"), QVariant("light"));
    ui->theme->addItem(QString("ARS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ARS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ARS-traditional"), QVariant("trad"));
