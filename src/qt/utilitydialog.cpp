    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Aeriscoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Aeriscoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  aeriscoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Aeriscoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ARS, 0.1 ARS, 1 ARS and 10 ARS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://Aeriscoin.org\">https://Aeriscoin.org</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
                          tr("Aeriscoin Core is shutting down...") + "<br /><br />" +
