    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Aeris Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Aeris Core"));
...
All the Aeris in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://Aeris.org\">https://Aeris.org</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
                          tr("Aeris Core is shutting down...") + "<br /><br />" +
