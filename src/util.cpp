...
const char * const BITCOIN_CONF_FILENAME = "aeriscoin.conf";
const char * const BITCOIN_PID_FILENAME = "aeriscoind.pid";
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty aeriscoin.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override aeriscoin.conf
