...
const char * const BITCOIN_CONF_FILENAME = "aeris.conf";
const char * const BITCOIN_PID_FILENAME = "aerisd.pid";
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty aeris.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override aeris.conf
